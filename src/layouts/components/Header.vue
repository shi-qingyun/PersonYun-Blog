      ...
      >
        ...
        <div class="flex items-center md:order-2">
          <div class="flex mr-3">
            ...
            <a
              class="mt-4px"
              href="https://keyue.cloud.baidu.com/unit/experience?token=8e85e036-6205-4dfc-8be0-bbd308dd3de5"
              target="_blank"
              >AI</a
            >
            <div class="wenxinyiyan"></div>
          ...
          >
            <ul class="py-2" aria-labelledby="user-menu-button">
              <li v-if="$store.state.user.username === 'admin'">
                <a
          ...
          >
            ...
            <li>
              <a
                ...
                :class="[
                  currPath == '/category' ? 'text-blue-700' : 'text-gray-900',
                ]"
            ...
            <li>
              <a
                ...
                :class="[
                  currPath == '/tag' ? 'text-blue-700' : 'text-gray-900',
                ]"
            ...
            <li>
              <a
                ...
                :class="[
                  currPath == '/archive' ? 'text-blue-700' : 'text-gray-900',
                ]"
                class="block py-2 pl-3 pr-4 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700"
              >
                归档
      ...
      <div class="">
        <div class="my-header flex justify-between">
          ...
          <div>
            <el-button
              @click="
                (isArticlePublishEditorShow = false),
                  publishArticleFormRef.resetFields()
              "
              >取消</el-button
            >
...
const changeStyle = () => {
  ...
  if (isDark.value === true) {
    ...
    document.body.style = "background-color: #111827";
  } else {
...
.wenxinyiyan {
  background: url("@/assets/R-C.png") no-repeat;
