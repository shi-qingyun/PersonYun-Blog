      ...
      <el-col :span="5" :offset="0">
        <el-card shadow="never" class="border-1">
          ...
          <div class="flex items-center">
            <div class="mr-8">
              <el-icon
                class="text-gray-500 text-xl rounded-full bg-gray-100 w-10 h-10"
                ><img src="@/assets/svg/navication.svg"
              /></el-icon>
            </div>
            <div>
        ...
        >
          <div class="flex items-center">
            <div class="mr-8">
              <el-icon
                class="text-gray-500 text-xl rounded-full bg-gray-100 w-10 h-10"
                ><img src="@/assets/svg/feedback.svg"
              /></el-icon>
            </div>
            <div>
